...
public class Solution {
    ...
    private static Set<List<Integer>> getAllPossibleDiag(int dim, int trace) {
        ...
        for (int i = 1; i <= trace - dim + 1; i++) {
            int temp = i;
            Set<List<Integer>> subProbSoln = getAllPossibleDiag(dim - 1, trace - i);
